...
Object.defineProperty(t, (void 0, "symbol" == typeof (n = a(o.key, "string")) ? n : String(n)), o);
}
var n;
}
function s(t, e, i) {
...
var l = new n.default.Vec3(), c = new n.default.Vec3(), h = cc.Vec3, u = function() {
function t() {
...
i.applyForce(h.copy(l, t), h.copy(c, e));
};
e.applyImpulse = function(t, e) {
null == e && (e = h.ZERO);
var i = this._sharedBody.body;
i.isSleeping() && i.wakeUp();
i.applyImpulse(h.copy(l, t), h.copy(c, e));
};
e.applyLocalForce = function(t, e) {
null == e && (e = h.ZERO);
var i = this._sharedBody.body;
i.isSleeping() && i.wakeUp();
i.applyLocalForce(h.copy(l, t), h.copy(c, e));
};
e.applyLocalImpulse = function(t, e) {
null == e && (e = h.ZERO);
var i = this._sharedBody.body;
i.isSleeping() && i.wakeUp();
i.applyLocalImpulse(h.copy(l, t), h.copy(c, e));
};
...
o.configurable = !0;
"value" in o && (o.writable = !0);
Object.defineProperty(t, (void 0, "symbol" == typeof (n = h(o.key, "string")) ? n : String(n)), o);
}
var n;
}
function c(t, e, i) {
...
var u = cc.Node._LocalDirtyFlag.PHYSICS_SCALE, p = cc.Quat, d = cc.Vec3, y = cc.js.array.fastRemoveAt, f = new d(), v = new p(), m = [], g = {
...
e.getWorldPosition(f);
e.getWorldRotation(v);
d.copy(this.body.position, f);
p.copy(this.body.quaternion, v);
if (e._localMatDirty & u) {
...
d.copy(f, this.body.position);
p.copy(v, this.body.quaternion);
this.node.setWorldPosition(f);
this.node.setWorldRotation(v);
}
};
e.destroy = function() {
...
if (e) {
g.selfCollider = e.collider;
g.otherCollider = i ? i.collider : null;
var o = 0;
for (o = g.contacts.length; o--; ) m.push(g.contacts.pop());
for (o = 0; o < t.contacts.length; o++) {
var n = t.contacts[o];
if (m.length > 0) {
var r = m.pop();
d.copy(r.contactA, n.ri);
d.copy(r.contactB, n.rj);
d.copy(r.normal, n.ni);
g.contacts.push(r);
} else {
var l = {
contactA: d.copy(new d(), n.ri),
contactB: d.copy(new d(), n.rj),
normal: d.copy(new d(), n.ni)
};
g.contacts.push(l);
}
}
...
var c = this.shapes[o];
g.type = a.deprecatedEventMap[g.type];
c.collider.emit(g.type, g);
g.type = t.event;
c.collider.emit(g.type, g);
}
}
...
i.x = parseFloat(f.x.toFixed(3));
i.y = parseFloat(f.y.toFixed(3));
i.z = parseFloat(f.z.toFixed(3));
var o = this.body.quaternion;
o.x = parseFloat(v.x.toFixed(12));
o.y = parseFloat(v.y.toFixed(12));
o.z = parseFloat(v.z.toFixed(12));
o.w = parseFloat(v.w.toFixed(12));
if (e._localMatDirty & u) {
...
i.CannonSharedBody = b;
b.sharedBodiesMap = new Map();
}, {
"../../../../../external/cannon/cannon": 24,
...
o.configurable = !0;
"value" in o && (o.writable = !0);
Object.defineProperty(t, (void 0, "symbol" == typeof (n = u(o.key, "string")) ? n : String(n)), o);
}
var n;
}
function h(t, e, i) {
...
var p = cc.Vec3, d = cc.js.array.fastRemoveAt, y = function() {
function t() {
this.bodies = [];
this._world = void 0;
...
m(t, e.maxDistance);
(0, r.toCannonRaycastOptions)(g, e);
var o = this._world.raycastClosest(f, v, g, this._raycastResult);
...
m(t, e.maxDistance);
(0, r.toCannonRaycastOptions)(g, e);
return this._world.raycastAll(f, v, g, function(t) {
var e = i.add();
...
i.CannonWorld = y;
var f = new n.default.Vec3(), v = new n.default.Vec3();
function m(t, e) {
p.copy(f, t.o);
t.computeHit(v, e);
}
...
o.configurable = !0;
"value" in o && (o.writable = !0);
Object.defineProperty(t, (void 0, "symbol" == typeof (n = c(o.key, "string")) ? n : String(n)), o);
}
var n;
}
function l(t, e, i) {
...
var p = cc.Vec3, d = new p(), y = function(t) {
h(e, t);
function e(e) {
var i;
...
key: "size",
set: function(t) {
this.collider.node.getWorldScale(d);
d.x = Math.abs(d.x);
d.y = Math.abs(d.y);
d.z = Math.abs(d.z);
p.multiplyScalar(this.halfExtent, t, .5);
p.multiply(this.box.halfExtents, this.halfExtent, d);
...
var p = new cc.Vec3(), d = function(t) {
h(e, t);
function e(e) {
var i;
...
var v = cc._decorator, m = v.ccclass, g = v.property, b = cc.js.array.fastRemove, w = cc.math.equals, x = m("cc.PhysicsMaterial")(o = (n = ((a = function(t) {
d(e, t);
function e() {
var i;
...
return e;
}(cc.Asset)).allMaterials = [], a._idCounter = 0, a), r = f(n.prototype, "_friction", [ g ], {
configurable: !0,
enumerable: !0,
writable: !0,
...
var o, n, r, s, a, l, c, h, u = t("../../instance"), p = t("./collider-component");
function d(t, e, i, o) {
i && Object.defineProperty(t, e, {
enumerable: i.enumerable,
configurable: i.configurable,
...
o.configurable = !0;
"value" in o && (o.writable = !0);
Object.defineProperty(t, (void 0, "symbol" == typeof (n = v(o.key, "string")) ? n : String(n)), o);
}
var n;
}
function f(t, e, i) {
...
var x = cc._decorator, _ = x.ccclass, B = x.executeInEditMode, S = x.executionOrder, E = x.menu, M = x.property, C = x.help, A = cc.Vec3, z = (o = _("cc.BoxCollider3D"), 
n = S(98), r = E("i18n:MAIN_MENU.component.physics/Collider/Box 3D"), s = C("i18n:COMPONENT.help_url.physics-collider"), 
a = M({
type: cc.Vec3
}), o(l = n(l = r(l = B(l = s(l = (w((c = function(t) {
g(e, t);
function e() {
var e;
d(e = t.call(this) || this, "_size", h, m(e));
e._shape = (0, u.createBoxShape)(e._size);
return e;
}
f(e, [ {
key: "size",
...
return e;
}(p.Collider3D)).prototype, "size", [ a ], Object.getOwnPropertyDescriptor(c.prototype, "size"), c.prototype), 
h = w(c.prototype, "_size", [ M ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
o.configurable = !0;
"value" in o && (o.writable = !0);
Object.defineProperty(t, (void 0, "symbol" == typeof (n = m(o.key, "string")) ? n : String(n)), o);
}
var n;
}
function v(t, e, i) {
...
var _ = cc._decorator, B = _.ccclass, S = _.property, E = cc.Vec3, M = (o = B("cc.Collider3D"), 
n = S({
...
y(e, "_material", h, g(e));
y(e, "_isTrigger", u, g(e));
y(e, "_center", p, g(e));
cc.EventTarget.call(g(e));
return e;
}
var i = e.prototype;
i.on = function() {};
...
x(c.prototype, "isTrigger", [ r ], Object.getOwnPropertyDescriptor(c.prototype, "isTrigger"), c.prototype), 
x(c.prototype, "center", [ s ], Object.getOwnPropertyDescriptor(c.prototype, "center"), c.prototype), 
h = x(c.prototype, "_material", [ a ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
i.Collider3D = M;
cc.js.mixin(M.prototype, cc.EventTarget.prototype);
}, {
...
var v = cc._decorator, m = v.ccclass, g = v.executeInEditMode, b = v.executionOrder, w = v.menu, x = v.property, _ = v.help, B = m("cc.SphereCollider3D")(o = b(98)(o = w("i18n:MAIN_MENU.component.physics/Collider/Sphere 3D")(o = _("i18n:COMPONENT.help_url.physics-collider")(o = g(o = (f((n = function(t) {
d(e, t);
function e() {
var e;
...
return e;
}(a.Collider3D)).prototype, "radius", [ x ], Object.getOwnPropertyDescriptor(n.prototype, "radius"), n.prototype), 
r = f(n.prototype, "_radius", [ x ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
var o, n, r, s, a, l, c, h, u, p, d, y, f, v, m, g = t("./rigid-body-component");
function b(t, e, i, o) {
i && Object.defineProperty(t, e, {
enumerable: i.enumerable,
configurable: i.configurable,
...
o.configurable = !0;
"value" in o && (o.writable = !0);
Object.defineProperty(t, (void 0, "symbol" == typeof (n = _(o.key, "string")) ? n : String(n)), o);
}
var n;
}
function x(t, e, i) {
...
var C = cc._decorator, A = C.ccclass, z = C.executeInEditMode, P = C.executionOrder, T = C.menu, F = C.property, R = C.requireComponent, q = C.disallowMultiple, O = C.help, j = cc.Vec3, I = (o = A("cc.ConstantForce"), 
n = P(98), r = R(g.RigidBody3D), s = T("i18n:MAIN_MENU.component.physics/Constant Force 3D"), 
a = O("i18n:COMPONENT.help_url.constantforce"), l = F({
displayOrder: 0
}), c = F({
displayOrder: 1
}), h = F({
...
displayOrder: 3
}), o(p = n(p = r(p = s(p = a(p = q(p = z(p = (d = function(t) {
S(e, t);
function e() {
for (var e, i = arguments.length, o = new Array(i), n = 0; n < i; n++) o[n] = arguments[n];
(e = t.call.apply(t, [ this ].concat(o)) || this)._rigidbody = null;
b(e, "_force", y, B(e));
b(e, "_localForce", f, B(e));
b(e, "_torque", v, B(e));
b(e, "_localTorque", m, B(e));
e._mask = 0;
return e;
}
var i = e.prototype;
i.onLoad = function() {
this._rigidbody = this.node.getComponent(g.RigidBody3D);
...
return e;
}(cc.Component), y = M(d.prototype, "_force", [ F ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), m = M(d.prototype, "_localTorque", [ F ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), M(d.prototype, "force", [ l ], Object.getOwnPropertyDescriptor(d.prototype, "force"), d.prototype), 
M(d.prototype, "localForce", [ c ], Object.getOwnPropertyDescriptor(d.prototype, "localForce"), d.prototype), 
M(d.prototype, "torque", [ h ], Object.getOwnPropertyDescriptor(d.prototype, "torque"), d.prototype), 
M(d.prototype, "localTorque", [ u ], Object.getOwnPropertyDescriptor(d.prototype, "localTorque"), d.prototype), 
d)) || p) || p) || p) || p) || p) || p) || p);
i.ConstantForce = I;
}, {
...
var o, n, r, s, a, l, c, h, u, p, d, y, f, v, m, g, b, w, x, _, B, S, E = t("../instance");
function M(t, e, i, o) {
i && Object.defineProperty(t, e, {
enumerable: i.enumerable,
configurable: i.configurable,
...
o.configurable = !0;
"value" in o && (o.writable = !0);
Object.defineProperty(t, (void 0, "symbol" == typeof (n = z(o.key, "string")) ? n : String(n)), o);
}
var n;
}
function A(t, e, i) {
...
var q = cc._decorator, O = q.ccclass, j = q.disallowMultiple, I = q.executeInEditMode, N = q.executionOrder, V = q.menu, k = q.property, L = q.help, W = cc.Vec3, D = (o = O("cc.RigidBody3D"), 
n = N(99), r = V("i18n:MAIN_MENU.component.physics/Rigid Body 3D"), s = L("i18n:COMPONENT.help_url.physics-rigidbody"), 
a = k({
displayOrder: 0
}), l = k({
displayOrder: 1
...
displayOrder: 7
}), o(f = n(f = r(f = s(f = I(f = j(f = (R((v = function(t) {
T(e, t);
function e() {
var e;
...
e._allowSleep = !0;
M(e, "_mass", m, P(e));
M(e, "_linearDamping", g, P(e));
M(e, "_angularDamping", b, P(e));
M(e, "_fixedRotation", w, P(e));
M(e, "_isKinematic", x, P(e));
M(e, "_useGravity", _, P(e));
M(e, "_linearFactor", B, P(e));
M(e, "_angularFactor", S, P(e));
e._body = (0, E.createRigidBody)();
return e;
}
var i = e.prototype;
i.__preload = function() {
...
return e;
}(cc.Component)).prototype, "mass", [ a ], Object.getOwnPropertyDescriptor(v.prototype, "mass"), v.prototype), 
R(v.prototype, "linearDamping", [ l ], Object.getOwnPropertyDescriptor(v.prototype, "linearDamping"), v.prototype), 
R(v.prototype, "angularDamping", [ c ], Object.getOwnPropertyDescriptor(v.prototype, "angularDamping"), v.prototype), 
R(v.prototype, "isKinematic", [ h ], Object.getOwnPropertyDescriptor(v.prototype, "isKinematic"), v.prototype), 
R(v.prototype, "useGravity", [ u ], Object.getOwnPropertyDescriptor(v.prototype, "useGravity"), v.prototype), 
R(v.prototype, "fixedRotation", [ p ], Object.getOwnPropertyDescriptor(v.prototype, "fixedRotation"), v.prototype), 
R(v.prototype, "linearFactor", [ d ], Object.getOwnPropertyDescriptor(v.prototype, "linearFactor"), v.prototype), 
R(v.prototype, "angularFactor", [ y ], Object.getOwnPropertyDescriptor(v.prototype, "angularFactor"), v.prototype), 
m = R(v.prototype, "_mass", [ k ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), g = R(v.prototype, "_linearDamping", [ k ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), b = R(v.prototype, "_angularDamping", [ k ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), w = R(v.prototype, "_fixedRotation", [ k ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), x = R(v.prototype, "_isKinematic", [ k ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), B = R(v.prototype, "_linearFactor", [ k ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), S = R(v.prototype, "_angularFactor", [ k ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
var b = cc._decorator, w = b.property, x = (0, b.ccclass)("cc.Physics3DManager")(o = (r = g((n = function() {
function t() {
...
}), h = g(n.prototype, "_useFixedTime", [ w ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
o.configurable = !0;
"value" in o && (o.writable = !0);
Object.defineProperty(t, (void 0, "symbol" == typeof (n = r(o.key, "string")) ? n : String(n)), o);
}
var n;
}
function n(t, e, i) {
...
var s = cc.Vec3, a = function() {
function t() {
this._hitPoint = new s();
this._distance = 0;
this._collidier = null;
}
var e = t.prototype;
e._assign = function(t, e, i) {
s.copy(this._hitPoint, t);
this._distance = e;
this._collidier = i;
};
e.clone = function() {
var e = new t();
s.copy(e._hitPoint, this._hitPoint);
...
cc.Mat3), l = cc.Mat4, c = cc.Vec3, h = cc.Quat, u = cc.Trs, p = [], d = cc.v3(), y = cc.quat(), f = new a(), v = f.m, m = cc.quat(), g = cc.mat4(), b = {};
function w(t, e) {
void 0 === e && (e = !1);
...
keywords: [ "cannon.js", "cocos", "creator", "physics.10dc9", "engine", "3d" ],
scripts: {
...
var i = r, o = i[0], n = i[1], s = i[2], a = i[3], l = i[4], c = i[5], h = i[6], u = i[7];
this.getCorners(o, n, s, a, l, c, h, u);
for (var p = 0; 8 !== p; p++) {
var d = i[p];
t.pointToLocal(d, d);
}
...
for (var o = t.numObjects(), r = t.bodies, a = this.aabbMax, l = this.aabbMin, c = this.nx, h = this.ny, u = this.nz, p = h * u, d = u, y = 1, f = a.x, v = a.y, m = a.z, g = l.x, b = l.y, w = l.z, x = c / (f - g), _ = h / (v - b), B = u / (m - w), S = (f - g) / c, E = (v - b) / h, M = (m - w) / u, C = .5 * Math.sqrt(S * S + E * E + M * M), A = n.types, z = A.SPHERE, P = A.PLANE, T = (A.BOX, 
A.COMPOUND, A.CONVEXPOLYHEDRON, this.bins), F = this.binLengths, R = this.bins.length, q = 0; q !== R; q++) F[q] = 0;
var O = Math.ceil;
...
switch (I.type) {
case z:
var N = it.position.x, V = it.position.y, k = it.position.z, L = I.radius;
j(N - L, V - L, k - L, N + L, V + L, k + L, it);
break;

case P:
I.worldNormalNeedsUpdate && I.computeWorldNormal(it.quaternion);
var W = I.worldNormal, D = g + .5 * S - it.position.x, U = b + .5 * E - it.position.y, G = w + .5 * M - it.position.z, H = s;
H.set(D, U, G);
for (var K = 0, Q = 0; K !== c; K++, Q += p, H.y = U, H.x += S) for (var X = 0, Y = 0; X !== h; X++, 
...
i.vsub(e, u);
t.vsub(e, p);
var n, r, s = j.dot(j), a = j.dot(u), l = j.dot(p), c = u.dot(u), h = u.dot(p);
...
if (!(N(this.from, this._direction, i) > t.boundingSphereRadius)) {
var n = this[t.type];
...
h = Math.min(h, p[0] + 1);
u = Math.min(u, p[1] + 1);
for (var y = l; y < h; y++) for (var f = c; f < u; f++) {
...
var r = this.from, s = this.to, a = t.radius, l = Math.pow(s.x - r.x, 2) + Math.pow(s.y - r.y, 2) + Math.pow(s.z - r.z, 2), c = 2 * ((s.x - r.x) * (r.x - i.x) + (s.y - r.y) * (r.y - i.y) + (s.z - r.z) * (r.z - i.z)), h = Math.pow(r.x - i.x, 2) + Math.pow(r.y - i.y, 2) + Math.pow(r.z - i.z, 2) - Math.pow(a, 2), u = Math.pow(c, 2) - 4 * l * h, p = S, d = E;
if (!(u < 0)) if (0 === u) {
r.lerp(s, u, p);
p.vsub(i, d);
d.normalize();
...
var y = (-c - Math.sqrt(u)) / (2 * l), f = (-c + Math.sqrt(u)) / (2 * l);
if (y >= 0 && y <= 1) {
r.lerp(s, y, p);
p.vsub(i, d);
d.normalize();
...
for (var s = M, a = C, l = r && r.faceList || null, c = t.faces, h = t.vertices, u = t.faceNormals, p = this._direction, y = this.from, f = this.to, w = y.distanceTo(f), x = l ? l.length : c.length, _ = this.result, B = 0; !_._shouldStop && B < x; B++) {
var S = l ? l[B] : B, E = c[S], A = u[S], z = e, P = i;
a.copy(h[E[0]]);
z.vmult(a, a);
a.vadd(P, a);
a.vsub(y, a);
...
z.vmult(m, m);
P.vadd(m, m);
for (var R = 1; !_._shouldStop && R < E.length - 1; R++) {
g.copy(h[E[R]]);
b.copy(h[E[R + 1]]);
z.vmult(g, g);
z.vmult(b, b);
...
var A = new i(), z = new i(), P = new i(), T = new i(), F = new i(), R = new i(), q = (new a(), 
[]), O = new n();
l.prototype.intersectTrimesh = function(t, e, i, o, r, s) {
var a = A, l = q, c = O, h = C, u = z, p = P, y = T, f = R, w = F, x = (s && s.faceList, 
...
for (var M = 0, j = l.length; !this.result._shouldStop && M !== j; M++) {
var I = l[M];
t.getNormal(I, a);
t.getVertex(x[3 * I], m);
m.vsub(p, h);
var N = u.dot(a), V = a.dot(h) / N;
if (!(V < 0)) {
u.scale(V, v);
v.vadd(p, v);
t.getVertex(x[3 * I + 1], g);
t.getVertex(x[3 * I + 2], b);
var k = v.distanceSquared(p);
if (!(!d(v, g, m, b) && !d(v, m, g, b) || k > E)) {
n.vectorToWorldFrame(e, a, w);
n.pointToWorldFrame(i, e, v, f);
this.reportIntersection(w, f, r, o, I);
}
}
}
l.length = 0;
...
var h = this.coneEquation = new o(t, e, s), u = this.twistEquation = new n(t, e, s);
...
var h = this.rotationalEquation1 = new o(t, e, s), u = this.rotationalEquation2 = new o(t, e, s), p = this.motorEquation = new n(t, e, a);
p.enabled = !1;
...
var a = new r(), l = new r();
s.prototype.update = function() {
var t = this.bodyA, e = this.bodyB, o = this.motorEquation, n = this.rotationalEquation1, r = this.rotationalEquation2, s = a, c = l, h = this.axisA, u = this.axisB;
i.prototype.update.call(this);
t.quaternion.vmult(h, s);
e.quaternion.vmult(u, c);
...
var h = this.rotationalEquation1 = new o(t, e, r), u = this.rotationalEquation2 = new o(t, e, r), p = this.rotationalEquation3 = new o(t, e, r);
this.equations.push(h, u, p);
}
r.prototype = new i();
r.constructor = r;
...
var e = this.a, i = this.b, o = this.axisA, r = this.axisB, l = s, c = a, h = this.jacobianElementA, u = this.jacobianElementB;
o.cross(r, l);
r.cross(o, c);
h.rotational.copy(c);
u.rotational.copy(l);
...
var e = this.a, i = this.b, o = this.bi, n = this.bj, l = this.ri, c = this.rj, h = r, u = s, p = o.velocity, d = o.angularVelocity, y = (o.force, 
...
return -w * e - (x * y.dot(b) - x * p.dot(b) + f.dot(u) - d.dot(h)) * i - t * this.computeGiMf();
};
var l = new o(), c = new o(), h = new o(), u = new o(), p = new o();
n.prototype.getImpactVelocityAlongNormal = function() {
var t = l, e = c, i = h, o = u, n = p;
...
var t = this.jacobianElementA, e = this.jacobianElementB, i = this.bi, o = this.bj, n = i.force, c = i.torque, h = o.force, u = o.torque, p = i.invMassSolve, d = o.invMassSolve;
n.scale(p, r);
h.scale(d, s);
...
var e = t.x, i = t.y, o = t.z, n = t.w, r = e + e, s = i + i, a = o + o, l = e * r, c = e * s, h = e * a, u = i * s, p = i * a, d = o * a, y = n * r, f = n * s, v = n * a, m = this.elements;
m[0] = 1 - (u + d);
m[1] = c - v;
m[2] = h + f;
m[3] = c + v;
...
e = e || new i();
var o = t.x, n = t.y, r = t.z, s = this.x, a = this.y, l = this.z, c = this.w, h = c * o + a * r - l * n, u = c * n + l * o - s * r, p = c * r + s * n - a * o, d = -s * o - a * n - l * r;
e.x = h * c + d * -s + u * -l - p * -a;
e.y = u * c + d * -a + p * -s - h * -l;
e.z = p * c + d * -l + h * -a - u * -s;
return e;
...
i = o.atan2(2 * a * c - 2 * s * l, 1 - 2 * p - 2 * d);
n = Math.asin(2 * h);
r = o.atan2(2 * s * c - 2 * a * l, 1 - 2 * u - 2 * d);
}
break;
...
i = i || new n();
var r, s, a, l, c, h = this.x, u = this.y, p = this.z, d = this.w, y = t.x, f = t.y, v = t.z, m = t.w;
if ((s = h * y + u * f + p * v + d * m) < 0) {
s = -s;
y = -y;
f = -f;
v = -v;
...
for (var t = this.shapes, e = this.shapeOffsets, i = this.shapeOrientations, o = t.length, n = h, r = u, s = this.quaternion, a = this.aabb, l = p, c = 0; c !== o; c++) {
var d = t[c];
s.vmult(e[c], n);
...
var o = this.velocity, n = this.angularVelocity, r = this.position, s = this.force, a = this.torque, l = this.quaternion, h = this.invMass, u = this.invInertiaWorld, p = this.linearFactor, d = h * t;
o.x += s.x * d * p.x;
o.y += s.y * d * p.y;
o.z += s.z * d * p.z;
...
this.chassisBody.quaternion.mult(h, p);
p.mult(u, p);
p.normalize();
...
var n = new i(), r = new i(), s = new i(), a = new i(), l = new i(), c = new i(), h = new i(), u = new i(), p = new i(), d = new i(), y = new i();
o.prototype.applyForce = function() {
var t = this.stiffness, e = this.damping, i = this.restLength, o = this.bodyA, f = this.bodyB, v = n, m = r, g = s, b = a, w = y, x = l, _ = c, B = h, S = u, E = p, M = d;
...
var h = new o(), u = new o(), p = new o(), d = new o(), y = new o(), f = new o();
r.prototype.findSeparatingAxis = function(t, e, i, o, n, r, s, a) {
var l = h, c = u, v = p, m = d, g = y, b = f, w = Number.MAX_VALUE;
...
for (var a = w, l = x, c = _, h = B, u = S, p = E, d = M, y = C, f = o, v = [], m = -1, g = Number.MAX_VALUE, b = 0; b < this.faces.length; b++) {
...
var z = this.faces[m];
z.connectedFaces = [];
for (var P = 0; P < this.faces.length; P++) for (var T = 0; T < this.faces[P].length; T++) -1 !== z.indexOf(this.faces[P][T]) && P !== m && -1 === z.connectedFaces.indexOf(P) && z.connectedFaces.push(P);
f.length;
for (var F = z.length, R = 0; R < F; R++) {
var q = this.vertices[z[R]], O = this.vertices[z[(R + 1) % F]];
q.vsub(O, l);
c.copy(l);
i.vmult(c, c);
e.vadd(c, c);
...
e.vadd(p, p);
p.dot(u);
var j = z.connectedFaces[R];
d.copy(this.faceNormals[j]);
var I = this.getPlaneConstantOfFace(j);
y.copy(d);
i.vmult(y, y);
var N = I - y.dot(e);
this.clipFaceAgainstPlane(f, v, y, N);
...
y.copy(d);
i.vmult(y, y);
for (N = I - y.dot(e), P = 0; P < f.length; P++) {
var V = y.dot(f[P]) + N;
V <= n && (V = n);
if (V <= r) {
var k = f[P];
...
var s = t.vertices.length, a = F, l = 0, c = 0, h = R, u = t.vertices;
h.setZero();
...
function r(t, e, r, s, a) {
if (a) {
for (var l = s, c = n.cos, h = n.sin, u = r / 2, p = [], d = [], y = [ 0 ], f = [ 1 ], v = [], m = 2 * Math.PI / l, g = 0; g < l; g++) {
p.push(new i(t * c(m * g), u, t * h(m * g)));
p.push(new i(t * c(m * g), -u, t * h(m * g)));
if (g < l - 1) {
...
var a = [], l = new n(), c = new n(), h = new n(), u = new n();
...
var u = this.elementSize, p = Math.pow(t / u - l, 2) + Math.pow(e / u - c, 2) > Math.pow(t / u - (l + 1), 2) + Math.pow(e / u - (c + 1), 2);
this.getTriangle(l, c, p, o, n, r);
return p;
};
...
var o = this.data, n = c, r = h, s = u, p = a;
...
var u = h / o * n, p = c / i * Math.PI * 2, d = (t + e * a.cos(p)) * a.cos(u), y = (t + e * a.cos(p)) * a.sin(u), f = e * a.sin(p);
r.push(d, y, f);
}
...
var n = [], r = [], s = [];
o.prototype.solve = function(t, e) {
var i, o, a, l, c, h = 0, u = this.iterations, p = this.tolerance * this.tolerance, d = this.equations, y = d.length, f = e.bodies, v = f.length, m = t;
...
t("../math/Quaternion")), c = (t("../solver/Solver"), t("../utils/Vec3Pool")), h = t("../equations/ContactEquation"), u = t("../equations/FrictionEquation");
function p(t) {
...
for (var l = g, c = b, h = v, u = m, p = 0, d = t.length; p !== d; p++) {
...
if (C && (B.type < E.type ? C.call(this, B, E, h, u, l, c, y, f, B, E, x) : C.call(this, E, B, u, h, c, l, f, y, B, E, x)) && x) {
...
p.prototype[n.types.BOX | n.types.BOX] = p.prototype.boxBox = function(t, e, i, o, n, r, s, a, l, c, h) {
...
p.prototype[n.types.BOX | n.types.CONVEXPOLYHEDRON] = p.prototype.boxConvex = function(t, e, i, o, n, r, s, a, l, c, h) {
t.convexPolyhedronRepresentation.material = t.material;
t.convexPolyhedronRepresentation.collisionResponse = t.collisionResponse;
return this.convexConvex(t.convexPolyhedronRepresentation, e, i, o, n, r, s, a, t, e, h);
};
p.prototype[n.types.BOX | n.types.PARTICLE] = p.prototype.boxParticle = function(t, e, i, o, n, r, s, a, l, c, h) {
t.convexPolyhedronRepresentation.material = t.material;
t.convexPolyhedronRepresentation.collisionResponse = t.collisionResponse;
return this.convexParticle(t.convexPolyhedronRepresentation, e, i, o, n, r, s, a, t, e, h);
};
p.prototype[n.types.SPHERE] = p.prototype.sphereSphere = function(t, e, i, o, n, r, s, a, l, c, h) {
...
p.prototype[n.types.PLANE | n.types.TRIMESH] = p.prototype.planeTrimesh = function(t, e, i, o, n, r, l, c, h, u, p) {
var d = new s(), y = w;
y.set(0, 0, 1);
n.vmult(y, y);
...
if (y.dot(m) <= 0) {
if (p) return !0;
var g = this.createContactEquation(l, c, t, e, h, u);
g.ni.copy(y);
var b = _;
y.scale(m.dot(y), b);
d.vsub(b, b);
...
var B = new s(), S = new s(), E = (new s(), new s()), M = new s(), C = new s(), A = new s(), z = new s(), P = new s(), T = new s(), F = new s(), R = new s(), q = new s(), O = new s(), j = new i(), I = [];
p.prototype[n.types.SPHERE | n.types.TRIMESH] = p.prototype.sphereTrimesh = function(t, e, i, o, n, s, l, c, h, u, p) {
var d = C, y = A, f = z, v = P, m = T, g = F, b = j, w = M, x = S, _ = I;
a.pointToLocalFrame(o, s, i, m);
var N = t.radius;
b.lowerBound.set(m.x - N, m.y - N, m.z - N);
b.upperBound.set(m.x + N, m.y + N, m.z + N);
e.getTrianglesInAABB(b, _);
for (var V = E, k = t.radius * t.radius, L = 0; L < _.length; L++) for (var W = 0; W < 3; W++) {
e.getVertex(e.indices[3 * _[L] + W], V);
V.vsub(m, x);
if (x.norm2() <= k) {
w.copy(V);
a.pointToWorldFrame(o, s, w, V);
V.vsub(i, x);
if (p) return !0;
(G = this.createContactEquation(l, c, t, e, h, u)).ni.copy(x);
G.ni.normalize();
G.ri.copy(G.ni);
...
for (var H = R, K = q, Q = O, X = B, Y = (L = 0, _.length); L !== Y; L++) {
...
if (p) return !0;
G = this.createContactEquation(l, c, t, e, h, u);
g.vsub(m, G.ni);
G.ni.normalize();
G.ni.scale(t.radius, G.ri);
a.pointToWorldFrame(o, s, g, g);
...
var N = new s(), V = new s(), k = new s(), L = new s(), W = new s();
p.prototype[n.types.SPHERE | n.types.PLANE] = p.prototype.spherePlane = function(t, e, i, o, n, r, s, a, l, c, h) {
k.set(0, 0, 1);
r.vmult(k, k);
k.negate(k);
k.normalize();
...
p.prototype[n.types.SPHERE | n.types.BOX] = p.prototype.sphereBox = function(t, e, i, o, n, r, s, a, l, c, h) {
...
A.copy(p[(B + 1) % 3]);
z.copy(p[(B + 2) % 3]);
var P = A.norm(), T = z.norm();
A.normalize();
z.normalize();
var F = K.dot(A), R = K.dot(z);
if (F < P && F > -P && R < T && R > -T) {
...
for (var j = u.get(), I = J, N = 0; 2 !== N && !y; N++) for (var V = 0; 2 !== V && !y; V++) for (var k = 0; 2 !== k && !y; k++) {
j.set(0, 0, 0);
N ? j.vadd(p[0], j) : j.vsub(p[0], j);
V ? j.vadd(p[1], j) : j.vsub(p[1], j);
k ? j.vadd(p[2], j) : j.vsub(p[2], j);
o.vadd(j, I);
I.vsub(i, I);
if (I.norm2() < d * d) {
if (h) return !0;
y = !0;
(O = this.createContactEquation(s, a, t, e, l, c)).ri.copy(I);
O.ri.normalize();
O.ni.copy(O.ri);
O.ri.mult(d, O.ri);
O.rj.copy(j);
...
for (N = 0; N !== U && !y; N++) for (V = 0; V !== U && !y; V++) if (N % 3 != V % 3) {
p[V].cross(p[N], L);
L.normalize();
p[N].vadd(p[V], W);
O.copy(i);
...
var it = new s(), ot = new s(), nt = new s(), rt = new s(), st = new s(), at = new s(), lt = new s(), ct = new s(), ht = new s(), ut = new s();
p.prototype[n.types.SPHERE | n.types.CONVEXPOLYHEDRON] = p.prototype.sphereConvex = function(t, e, i, o, n, r, s, a, l, c, h) {
var u = this.v3pool;
i.vsub(o, it);
...
i.vsub(E, z);
if (A < 0 && z.dot(S) > 0) {
for (var P = [], T = 0, F = B.length; T !== F; T++) {
var R = u.get();
r.vmult(y[B[T]], R);
o.vadd(R, R);
P.push(R);
...
this.createFrictionEquationsFromContact(q, this.frictionResult);
T = 0;
for (var I = P.length; T !== I; T++) u.release(P[T]);
return;
}
for (T = 0; T !== B.length; T++) {
var N = u.get(), V = u.get();
r.vmult(y[B[(T + 1) % B.length]], N);
r.vmult(y[B[(T + 2) % B.length]], V);
o.vadd(N, N);
o.vadd(V, V);
var k = ot;
V.vsub(N, k);
...
var G = u.get();
W.vsub(i, G);
if (U > 0 && U * U < k.norm2() && G.norm2() < f * f) {
if (h) return !0;
...
this.result.push(q);
this.createFrictionEquationsFromContact(q, this.frictionResult);
for (T = 0, I = P.length; T !== I; T++) u.release(P[T]);
u.release(N);
u.release(V);
u.release(W);
u.release(G);
...
new s(), new s();
p.prototype[n.types.PLANE | n.types.BOX] = p.prototype.planeBox = function(t, e, i, o, n, r, s, a, l, c, h) {
e.convexPolyhedronRepresentation.material = e.material;
e.convexPolyhedronRepresentation.collisionResponse = e.collisionResponse;
...
p.prototype[n.types.PLANE | n.types.CONVEXPOLYHEDRON] = p.prototype.planeConvex = function(t, e, i, o, n, r, s, a, l, c, h) {
var u = pt, p = dt;
p.set(0, 0, 1);
n.vmult(p, p);
...
p.prototype[n.types.CONVEXPOLYHEDRON] = p.prototype.convexConvex = function(t, e, i, o, n, r, s, a, l, c, h, u, p) {
var d = vt;
...
p.prototype[n.types.PLANE | n.types.PARTICLE] = p.prototype.planeParticle = function(t, e, i, o, n, r, s, a, l, c, h) {
var u = gt;
u.set(0, 0, 1);
...
var xt = new s();
p.prototype[n.types.PARTICLE | n.types.SPHERE] = p.prototype.sphereParticle = function(t, e, i, o, n, r, s, a, l, c, h) {
var u = xt;
u.set(0, 0, 1);
o.vsub(i, u);
...
p.prototype[n.types.PARTICLE | n.types.CONVEXPOLYHEDRON] = p.prototype.convexParticle = function(t, e, i, o, n, r, s, a, l, c, h) {
...
p.prototype[n.types.BOX | n.types.HEIGHTFIELD] = p.prototype.boxHeightfield = function(t, e, i, o, n, r, s, a, l, c, h) {
t.convexPolyhedronRepresentation.material = t.material;
t.convexPolyhedronRepresentation.collisionResponse = t.collisionResponse;
return this.convexHeightfield(t.convexPolyhedronRepresentation, e, i, o, n, r, s, a, t, e, h);
};
var Ct = new s(), At = new s(), zt = [ 0 ];
p.prototype[n.types.CONVEXPOLYHEDRON | n.types.HEIGHTFIELD] = p.prototype.convexHeightfield = function(t, e, i, o, n, r, s, l, c, h, u) {
...
i.distanceTo(f) < e.pillarConvex.boundingSphereRadius + t.boundingSphereRadius && (C = this.convexConvex(t, e.pillarConvex, i, f, n, r, s, l, c, h, u, v, null));
if (u && C) return !0;
...
var Pt = new s(), Tt = new s();
p.prototype[n.types.SPHERE | n.types.HEIGHTFIELD] = p.prototype.sphereHeightfield = function(t, e, i, o, n, r, s, l, c, h, u) {
var p = e.data, d = t.radius, y = e.elementSize, f = Tt, v = Pt;
...
t("../equations/FrictionEquation"), t("./Narrowphase")), s = t("../utils/EventTarget"), a = t("../collision/ArrayCollisionMatrix"), l = t("../collision/ObjectCollisionMatrix"), c = t("../collision/OverlapKeeper"), h = t("../material/Material"), u = t("../material/ContactMaterial"), p = t("../objects/Body"), d = t("../utils/TupleDictionary"), y = t("../collision/RaycastResult"), f = t("../collision/AABB"), v = t("../collision/Ray"), m = t("../collision/NaiveBroadphase");
function g(t) {
t = t || {};
s.apply(this);
this.dt = -1;
...
this.dt = t;
var e, i = this.contacts, o = F, n = R, r = this.numObjects(), s = this.bodies, a = this.solver, l = this.gravity, c = this.doProfiling, h = this.profile, u = p.DYNAMIC, d = this.constraints, y = T, f = (l.norm(), 
l.x), v = l.y, m = l.z, b = 0;
c && (e = performance.now());
for (b = 0; b !== r; b++) if ((I = s[b]).useGravity && I.type === u) {
var w = I.force, x = I.mass;
w.x += x * f;
w.y += x * v;
w.z += x * m;
}
...
var I = (L = i[j]).bi, N = L.bj, V = L.si, k = L.sj;
V.material && k.material ? V.material.restitution >= 0 && k.material.restitution >= 0 && (L.restitution = V.material.restitution * k.material.restitution) : I.material && N.material && I.material.restitution >= 0 && N.material.restitution >= 0 && (L.restitution = I.material.restitution * N.material.restitution);
a.addEquation(L);
I.allowSleep && I.type === p.DYNAMIC && I.sleepState === p.SLEEPING && N.sleepState === p.AWAKE && N.type !== p.STATIC && N.velocity.norm2() + N.angularVelocity.norm2() >= 2 * Math.pow(N.sleepSpeedLimit, 2) && (I._wakeUpAfterNarrowphase = !0);
N.allowSleep && N.type === p.DYNAMIC && N.sleepState === p.SLEEPING && I.sleepState === p.AWAKE && I.type !== p.STATIC && I.velocity.norm2() + I.angularVelocity.norm2() >= 2 * Math.pow(I.sleepSpeedLimit, 2) && (N._wakeUpAfterNarrowphase = !0);
this.collisionMatrix.set(I, N, !0);
if (!this.collisionMatrixPrevious.get(I, N)) {
z.body = N;
z.contact = L;
I.dispatchEvent(z);
z.body = I;
...
this.bodyOverlapKeeper.set(I.id, N.id);
this.shapeOverlapKeeper.set(V.id, k.id);
}
...
for (b = 0; b !== r; b++) if ((I = s[b])._wakeUpAfterNarrowphase) {
I.wakeUp();
...
var U = Math.pow;
for (b = 0; b !== r; b++) if ((I = s[b]).type & u) {
var G = U(1 - I.linearDamping, t), H = I.velocity;
H.mult(G, H);
var K = I.angularVelocity;
if (K) {
var Q = U(1 - I.angularDamping, t);
K.mult(Q, K);
}
}
this.dispatchEvent(A);
for (b = 0; b !== r; b++) (I = s[b]).preStep && I.preStep.call(I);
c && (e = performance.now());
...
for (b = 0; b !== r; b++) {
var Z = (I = s[b]).postStep;
Z && Z.call(I);
}
if (this.allowSleep) {
for (b = 0; b !== r; b++) s[b].sleepTick(this.time);
g.SLEEPING = !0;
for (b = 0; b !== r; b++) if ((I = s[b]).type != p.STATIC && !I.isSleeping()) {
g.SLEEPING = !1;
break;
}
} else g.SLEEPING = !1;
